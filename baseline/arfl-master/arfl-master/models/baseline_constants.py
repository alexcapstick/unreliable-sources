...
MAIN_PARAMS = {
    ...
    'cifar10': {
        'small': (30, 10, 2),
        'medium': (40, 1, 10), # num rounds, eval every, clients per round
        'large': (2000, 1, 10)
    },
    ...
    'fmnist': {
        'small': (30, 10, 2),
        'medium': (40, 40, 10), # num rounds, eval every, clients per round
        'large': (2000, 1, 10)
    },
...
MODEL_PARAMS = {
    ...
    'cifar10.cnn': (0.01, 100, 128),  # lr, num_classes, test_batch_size


    'fmnist.mlp': (0.001, 10, 50),  # lr, num_classes, test_batch_size
